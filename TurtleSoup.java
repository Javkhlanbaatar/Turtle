...
public class TurtleSoup {
    ...
    public static void drawPersonalArt(Turtle turtle, int sidelength) {
    	PenColor k = null;
    	for (int a=0 ; a<250 ; a=5+a) {
    		Object[] proper_noun = {k.BLACK,k.GRAY,k.RED,k.PINK,k.ORANGE,k.YELLOW, k.GREEN,k.CYAN,k.BLUE,k.MAGENTA};
			Random random = new Random();
			int index = random.nextInt(proper_noun.length);
    		turtle.forward(a);
    		turtle.turn(250);
    		turtle.color((PenColor) proper_noun[index]);
    	}
    	/*
    	for(int i = 1; i < 720; i++)
    	{
